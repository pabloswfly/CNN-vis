...
# ---------------------------------------------------------------------------------------------------------------------
    ...
    if function == 'saliency':
        for b_m in [None, 'guided', 'relu']:
            plot_saliency(model, images_withidx, layer_name=layer_name, backprop_mod=b_m)

    # Gradient-Class Activation Maps
    elif function == 'grad-cam':
            plot_gradCAM(model, images_withidx, layer_name=layer_name)

    # Activation Maximization Maps
    elif function == 'activation-max':
        plot_actmax(model, backprop_mod='guided')
